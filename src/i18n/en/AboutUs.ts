export const AboutUs = {
  titleImage: 'Transforming the world’s health, one cough at a time.',
  sectionOurMissionStory: {
    ...
    titleStory: 'Story',
    textStory:
      'When the pandemic hit, Virufy’s founder, Amil Khanzada, knew smartphones were omnipresent and that COVID impacted the nose, throat, and lungs. He hypothesized that breathing and cough sounds could be analyzed with machine learning to detect COVID patterns. Wanting to make a positive impact, he orchestrated a clinical study with 362 patients in an esteemed university hospital. The original team of Virufy, beginning with Stanford graduate AI students, expanded to volunteers from universities globally.',
  },
  sectionOurValues: {
    title: 'Values',
    Transformation: 'Transformation',
    textTransformation:
      'We aim to transform expensive healthcare systems by using technology to drive necessary changes.',
    Collaboration: 'Collaboration',
    textCollaboration:
      'We commit to making rapid disease detection available to every person in the world, regardless of background.',
    Health: 'Health',
    textHealth:
      'We commit to always putting the health and well-being of all people across the globe first and foremost.',
    Affordability: 'Affordability',
    textAffordability:
      'We aim to use technology to make disease prevention and detection free for all people around the world.',
