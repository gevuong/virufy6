      ...
      <div className="absolute inset-0 flex justify-center items-center">
        <div className="max-w-screen-xl mx-auto flex flex-col p-4 md:p-8 lg:p-[9.6rem] text-center">
          <div className="flex flex-col text-center mt-[0.5rem] lg:mt-12 sm:text-center">
            ...
            />
            <p className="mt-[1rem] px-[10px] xl:px-[160px] text-[8px] sm:text-[12px] text-white leading-[1rem] xl:text-[24px] xl:leading-[2.5rem]">
              {subtitle}
            </p>
            <p className="mt-[1rem] xl:mt-[6rem] px-[9px] xl:px-[30px] text-[8px] sm:text-[14px] text-white leading-[0.8rem] sm:leading-[1rem] xl:text-[36px] xl:leading-[2.5rem] font-semibold">
              {text}
            </p>
          </div>
        </div>
